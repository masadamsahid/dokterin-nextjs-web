  ...
  return (
    <footer className="bg-gray-100">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex justify-center text-teal-600 gap-2">
          <Image src='/logo.svg' alt="Dokterin Logo" width={40} height={40} />
          <h1 className="text-primary font-bold text-4xl">Dokterin</h1>
        </div>
